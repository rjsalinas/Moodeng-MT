...
def translate_text(text, model_path="mbart50-finetuned-LoRA-best"):
    """Translate Filipino text to English using the latest fine-tuned LoRA model"""
    try:
        # Load base model
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python translate.py 'Filipino text here'")
        return
