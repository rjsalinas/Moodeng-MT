#!/usr/bin/env python3
"""
Clean Filipino-to-English Translation Script
...
def translate_text(text, model_path="fine-tuned-mbart-tl2en-best"):
    """Translate Filipino text to English"""
    try:
        # Load base model
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python simple_translate_clean.py 'Filipino text here'")
        return
