...
Differences from v1:
- LoRA r=256, alpha=512, dropout=0.1; target attn and feed-forward modules
- Larger effective batch via gradient accumulation
- AdamW with slightly lower LR (3e-5) and cosine schedule
- Evaluate BLEU/chrF every 3 epochs to save time
...
def main():
    ...
    lora_config = LoraConfig(
        r=256,  # Increased rank
        lora_alpha=512,  # Increased alpha
