...
if __name__ == "__main__":
    ...
    INPUT_FILE = os.path.join(script_dir, 'init-preprocess', 'extracted_cleaned_tweets.csv')
    OUTPUT_FILE = os.path.join(script_dir, 'annotated-preprocess', 'annotated_tweets.csv')
